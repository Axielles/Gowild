...
var OpenDataParisServices = /** @class */ (function () {
    function OpenDataParisServices(http) {
        this.http = http;
        this.dataFiltered = [];
        this.URL = 'https://opendata.paris.fr/api/records/1.0/search/?dataset=evenements-a-paris';
        ...
        this.urlBase = this.URL + "&q=date_start+%3C%3D+%23now()+AND+date_end+%3E%3D+%23now()&sort=-date_start&rows=2000";
...
module.exports = __webpack_require__(/*! /home/awacks/Documents/wcs/Projet3/Gowild/src/main.ts */"./src/main.ts");
